-- Step 4 - Final Fix: Create study plan and fix schema

-- 1. Create the study plan (this should work fine)
...
-- 2. Fix the schema - expand certification_goal field to allow longer values
ALTER TABLE user_profiles 
ALTER COLUMN certification_goal TYPE character varying(100);

-- 3. Now update the certification_goal with the full name
