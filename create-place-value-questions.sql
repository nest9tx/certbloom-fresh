-- 🎯 HIGH-QUALITY QUESTION BANK FOR PLACE VALUE AND NUMBER SENSE
-- Creating exemplary questions with detailed explanations and confidence-building features
...
BEGIN
    ...
    INSERT INTO content_items (
        concept_id, type, question_text, correct_answer, difficulty_level,
    ...
    -- Question 4: Expanded Form Understanding
    INSERT INTO content_items (
        concept_id, type, question_text, correct_answer, difficulty_level,
        detailed_explanation, real_world_application, confidence_building_tip,
        common_misconceptions, memory_aids, anxiety_note
        ...
        place_value_concept_id, 'question',
        'A student writes the number 3,059 in expanded form as 3,000 + 50 + 9. What error did the student make?',
        'B',
        'Intermediate',
        'The student forgot to include 0 tens, which should be written as + 0. The complete expanded form is 3,000 + 0 + 50 + 9, or more commonly 3,000 + 50 + 9. The student actually wrote it correctly by omitting the zero term. However, if the question expects full expanded form including zeros, it would be 3,000 + 0 + 50 + 9.',
        'Understanding expanded form helps teachers explain place value and diagnose why students might struggle with addition or subtraction algorithms.',
        'Expanded form makes place value visible and concrete. You''re learning to break down complex concepts into understandable parts - a key teaching skill.',
        ARRAY['Including unnecessary zero terms in expanded form', 'Forgetting that we can omit zero terms in expanded form'],
        ARRAY['Expanded form shows each place value as a separate addend', 'Zero terms can be included or omitted'],
        'Expanded form is just another way to write numbers. There''s flexibility in how detailed you want to be.'
    ) RETURNING id INTO question_id;

    -- Add answer choices for Question 4
    INSERT INTO answer_choices (content_item_id, choice_letter, choice_text, explanation, is_correct) VALUES
    (question_id, 'A', 'The student included too many terms', 'Incorrect. The terms shown (3,000 + 50 + 9) are all necessary and correct.', false),
    (question_id, 'B', 'The student didn''t make an error', 'Correct! The expanded form 3,000 + 50 + 9 is accurate. Zero terms can be omitted.', true),
    (question_id, 'C', 'The student forgot the hundreds place', 'Incorrect. There are 0 hundreds in 3,059, so omitting this term is acceptable.', false),
    (question_id, 'D', 'The student added instead of multiplying', 'Incorrect. Expanded form uses addition to show the sum of place values.', false);

    -- Question 5: Real-world application with larger numbers
    INSERT INTO content_items (
        concept_id, type, question_text, correct_answer, difficulty_level,
        detailed_explanation, real_world_application, confidence_building_tip,
        common_misconceptions, memory_aids, anxiety_note
        ...
        place_value_concept_id, 'question',
        'The enrollment at Lincoln Elementary is 1,847 students. Which digit represents the number of thousands of students?',
        'A',
        'Beginner',
        'In the number 1,847, the digit 1 is in the thousands place. This means there is 1 thousand students, plus 847 additional students, for a total of 1,847 students.',
        'School administrators and teachers work with enrollment numbers, budget figures, and assessment data that require place value understanding.',
        'You''re working with real numbers that schools actually use. These skills directly apply to your future teaching environment.',
        ARRAY['Confusing the digit with the place name', 'Thinking thousands means the total number rather than the place value'],
        ARRAY['The leftmost digit in a 4-digit number is always in the thousands place', 'Think "1 thousand and 847 more"'],
        'School enrollment numbers are concrete and meaningful. You''re connecting mathematics to real educational contexts.'
    ) RETURNING id INTO question_id;

    -- Add answer choices for Question 5
    INSERT INTO answer_choices (content_item_id, choice_letter, choice_text, explanation, is_correct) VALUES
    (question_id, 'A', '1', 'Correct! The 1 is in the thousands place, representing 1 thousand students.', true),
    (question_id, 'B', '8', 'Incorrect. The 8 is in the hundreds place, not the thousands place.', false),
    (question_id, 'C', '4', 'Incorrect. The 4 is in the tens place, not the thousands place.', false),
    (question_id, 'D', '7', 'Incorrect. The 7 is in the ones place, not the thousands place.', false);
