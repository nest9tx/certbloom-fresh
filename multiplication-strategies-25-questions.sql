...
BEGIN
    ...
    INSERT INTO answer_choices (question_id, choice_text, is_correct, choice_order, explanation) VALUES
        ...
        (question_id, '77', FALSE, 3, 'Incorrect - This does not follow any multiplication pattern.'),
    ...
    INSERT INTO answer_choices (question_id, choice_text, is_correct, choice_order, explanation) VALUES
        ...
        (question_id, '8 + 8 + 8', FALSE, 4, 'While this equals 3 * 8, it is written as addition.');
    ...
    INSERT INTO answer_choices (question_id, choice_text, is_correct, choice_order, explanation) VALUES
        ...
        (question_id, 'Increases by 1 each time', FALSE, 4, 'Incorrect - The ones place does not increase by 1.');
    ...
    INSERT INTO answer_choices (question_id, choice_text, is_correct, choice_order, explanation) VALUES
        ...
        (question_id, '4 + 6 + 4 + 6', FALSE, 4, 'Incorrect - This alternates and does not show groups.');
    ...
    INSERT INTO answer_choices (question_id, choice_text, is_correct, choice_order, explanation) VALUES
        (question_id, 'Memorize the fact through drill', FALSE, 1, 'Incorrect - Does not build understanding.'),
    ...
    INSERT INTO answer_choices (question_id, choice_text, is_correct, choice_order, explanation) VALUES
        (question_id, '18', FALSE, 1, 'Incorrect - This does not follow the *4 pattern.'),
